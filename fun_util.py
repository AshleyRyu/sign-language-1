...
from PIL import ImageFont, ImageDraw, Image # jw added
...
# b,g,r,a = 0,255,0,0
# fontpath = "./fonts/HANDotum.ttf"
# # fontpath = "fonts/gulim.ttc"
# font = ImageFont.truetype(fontpath, 20)
# font = ImageFont.truetype(fm.findfont(fm.FontProperties(family=fontpath),20))
# # unicode_font = ImageFont.truetype("gulim.ttc", 20)
# # draw.text ( (10,10), unicode_text, font=unicode_font, fill=font_color )

# # font = ImageFont.truetype(".fonts/HANDotum.ttf", 20, encoding="utf-8")
# # font = ImageFont.truetype(".fonts/HANDotum.ttf", 20)
...
def text_mode(cam):
	...
	while True:
		...
		draw = ImageDraw.Draw(img_pil)
		draw.text((30, 40), "원하는 수어를 입력하세요!", font=font, fill=(b,g,r,a))
		# draw.text((60, 70),  "김형준ABC123#GISDeveloper", font=font, fill=(b,g,r,a))
		# blackboard = np.array(img_pil)
		# cv2.putText(img,  "by Dip2K", (250,120), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (b,g,r), 1, cv2.LINE_AA)


		# draw.text((60, 70), "유지원ABC123#GISDeveloper", font=font, fill=(b,g,r,a))
		blackboard = np.array(img_pil)
		# draw.text((60, 70),  unicode("유지원ABC123#GISDeveloper","utf-8"), font=font, fill=(b,g,r,a))
		# cv2.putText(blackboard, "Text Mode", (180, 50), cv2.FONT_HERSHEY_TRIPLEX, 1.5, (b,g,r), 1, cv2.LINE_AA)
		# cv2.putText(blackboard, "ㄱㄴㄷText Mode", (180, 50), cv2.FONT_HERSHEY_TRIPLEX, 1.5, (255, 0,0)) # original
		cv2.putText(blackboard, "Predicted text- " + text, (100, 200), cv2.FONT_HERSHEY_TRIPLEX, 1, (255, 255, 0))
		draw.text((30, 240), word, font=font, fill=(b,g,r,a))
####################
		# freetype.createFreeType2().loadFontData(fontFileName='Ubuntu-R.ttf',
		# 				id=0)
		# freetype.createFreeType2().putText(img=img,
		# 		text=word,
		# 		org=(15, 70),
		# 		fontHeight=60,
		# 		color=(255,  255, 255),
